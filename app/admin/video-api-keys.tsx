...
export default function AdminVideoApiKeysScreen() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.error('[AdminVideoApiKeys] load failed', e);
      }
    })();
  ...
  return (
    <AdminLayout title="Video API Keys">
      <Stack.Screen options={{ title: 'Video API Keys' }} />
      <View style={styles.container}>
        <Text style={styles.warning}>
          ⚠️ ADMIN ONLY - These API keys control video transcoding and streaming services
        </Text>
        
        <View style={styles.card}>
          <Text style={styles.caption}>Mux Video Processing</Text>
          <TextField
            testID="mux-token-id"
